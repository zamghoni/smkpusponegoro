  ...
  <?php $this->view('message')?>
      <section class="panel">
        <header class="panel-heading">
          ...
          <div class="text-left">
            <a href="<?=site_url('info')?>" class="btn btn-sm btn-danger"><i class="fa fa-undo"></i> Back</a>
          </div>
        </header>
        <div class="panel-body">
          <?php echo form_open_multipart('info/process') ?>
            ...
            <div class="form-group">
              <label class="col-md-2 control-label" for="id_kategori">Kategori *</label>
              <div class="col-md-10">
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                <?php if($subpage == 'Edit') {
                  if ($row->foto != null) {?>
                    <a class="img-thumbnail lightbox" href="<?=base_url('upload/info/'.$row->foto)?>" data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                      <img class="img-responsive" width="100px" src="<?=base_url('upload/info/'.$row->foto)?>">
                      <span class="zoom">
