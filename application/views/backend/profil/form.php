  ...
  <?php $this->view('message')?>
      <section class="panel">
        <header class="panel-heading">
          ...
          <div class="text-left">
            <a href="<?=site_url('profil')?>" class="btn btn-sm btn-danger"><i class="fa fa-undo"></i> Back</a>
          </div>
        </header>
        <div class="panel-body">
          <?php echo form_open_multipart('profil/process') ?>
            ...
            <div class="form-group">
              ...
              <div class="col-md-10">
                    <a class="img-thumbnail lightbox" href="<?=base_url('upload/profil/'.$row->foto)?>" data-plugin-options="{ &quot;type&quot;:&quot;image&quot; }">
                      <img class="img-responsive" width="150px" src="<?=base_url('upload/profil/'.$row->foto)?>">
                      <span class="zoom">
